...
public class Team extends User {
    ...
    private static final ArrayList<Team> teamList = new ArrayList<Team>(); // List of team instances
    private static final ArrayList<User> userListInTeam = new ArrayList<User>(); // List of users for particular team instance
    ...
    public Team getTeam () { // Gets current instance
